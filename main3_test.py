...
# test: left/right 마지막과 근처 n장의 영상을 이용
...
for region in regions:
    f = open(region + "_3_" + str(number_of_imgs) + ".csv", "w")
    ...
    for idx_q in index:
        ...
        print("Align photos")
        ba_api = BA_api()
        cam_L, eo_L, cam_R, eo_R = ba_api.alignphotos_3(images_to_process_train, query_L_label, query_R_label,
                                                        number_of_imgs, region)
